  ...
  _syncProfileToBackend(role, payload) {
    if (role === "student") {
      ...
      return studentApi
        ...
        .then(
          function (vo) {
            console.log("[onboarding] student getProfile ok", { hasProfile: !!(vo && (vo.id != null || vo.userId != null)) });
    ...
    if (role === "teacher") {
      ...
      return teacherApi.getProfile().then(
        function (vo) {
          console.log("[onboarding] teacher getProfile ok -> updateProfile", { hasProfile: !!(vo && (vo.id != null || vo.userId != null)) });
          if (vo && (vo.id != null || vo.userId != null)) {
